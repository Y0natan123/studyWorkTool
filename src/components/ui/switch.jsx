...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    {...props}
  >
    {/* App is RTL-only (dir="rtl" on <html>): translate-x is a physical transform that the
        browser does not flip automatically, so "checked" moves the thumb toward the visual
        left (-translate-x-4) instead of the LTR-default right (translate-x-4). */}
