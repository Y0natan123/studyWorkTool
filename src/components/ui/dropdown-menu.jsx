...
const DropdownMenuSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    {/* RTL: submenu opens toward the visual left, so the indicator points left */}
...
const DropdownMenuSubContent = React.forwardRef(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95",
      className
    )}
    {...props}
  />
...
const DropdownMenuShortcut = ({ className, ...props }) => (
  <span className={cn("me-auto text-xs tracking-widest opacity-60", className)} {...props} />
)
